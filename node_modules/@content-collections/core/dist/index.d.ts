...
type FileType = "data" | "javascript" | "typeDefinition";
type WriterHookContext = {
  fileType: FileType;
  content: string;
  filePath: string;
};
type WriterHookResult = {
  content: string;
};
type WriterHook = (ctx: WriterHookContext) => Promise<WriterHookResult> | WriterHookResult;
//#endregion
...
//#endregion
export { AnyCollection, AnyConfiguration, AnyContent, AnySingleton, Builder, BuilderEvents, CollectError, Collection, CollectionContext, CollectionRequest, Configuration, ConfigurationError, ConfigurationReloadError, ConfigurationWithCollections, ConfigurationWithContent, ContentType, Context, type Document, type GetTypeByName, Hooks, Meta, type Modification, Schema, Singleton, SingletonContext, SingletonRequest, SkippedSignal, TransformError, type Watcher, type WriterHook, type WriterHookContext, type WriterHookResult, createBuilder, createDefaultImport, createInternalBuilder, createNamedImport, defineCollection, defineConfig, defineParser, defineSingleton, isSingleton, skippedSymbol, suppressDeprecatedWarnings };