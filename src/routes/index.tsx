...
function Hero() {
  return (
    <section id="hero" className="hero">
      ...
      <div className="hero-content" style={{ animation: 'fadeUp 0.8s cubic-bezier(0.22,1,0.36,1) both' }}>
        {/* Profile picture */}
        ...
        <div className="hero-cta">
          ...
          <a href="#" className="btn-outline">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0120 9.414V19a2 2 0 01-2 2z" />
            </svg>
            Download Resume
          </a>
        </div>
      ...
      <div className="about-grid">
        <div className="reveal" style={{ transitionDelay: '0.1s' }}>
          <p className="about-text">
            I'm a third-year Computer Science student with a passion for building practical
            software and web solutions. Quick to adapt and always eager to solve real-world
            problems — from mobile fitness apps to AI-powered plant disease detectors.
          </p>
          <p className="about-text" style={{ marginTop: '1.25rem' }}>
            My work spans full-stack web development, mobile apps, and machine learning —
            always with a focus on shipping something real. I thrive in fast-paced
            environments like hackathons and love turning ideas into functional products.
          </p>
          <div style={{ marginTop: '2rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            <a href="mailto:nr14082005@gmail.com" className="btn-outline" style={{ fontSize: '0.82rem', padding: '0.5rem 1.1rem' }}>
              nr14082005@gmail.com
            </a>
            <a href="tel:+919136115989" className="btn-outline" style={{ fontSize: '0.82rem', padding: '0.5rem 1.1rem' }}>
              +91 9136115989
            </a>
          </div>
        </div>
  ...
  const projects = [
    {
      ...
      title: 'WorkFromCafe',
      desc: 'A live, crowdsourced discovery platform to help remote professionals find productive café workspaces — with real-time ratings, amenity filters, and community check-ins.',
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div className="timeline">
          ...
          <div className="timeline-item reveal" style={{ transitionDelay: '0.1s' }}>
            <div className="timeline-dot" style={{ background: 'var(--indigo)', boxShadow: '0 0 0 3px rgba(129,140,248,0.2), 0 0 12px rgba(129,140,248,0.4)' }} />
            <div className="glass-card edu-card">
        ...
        <div className="glass-card achievement-card reveal">
          <span className="trophy-icon">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#fbbf24" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M16 7H8M16 7c0 3.314-1.79 6-4 6s-4-2.686-4-6M16 7h2a2 2 0 012 2v1a4 4 0 01-4 4M8 7H6a2 2 0 00-2 2v1a4 4 0 004 4m4 0v4m0 0H9m3 0h3" />
            </svg>
          </span>
          ...
          <p className="achievement-desc">
            ...
            Built WorkFromCafe — a crowdsourced café discovery platform for remote workers.
          </p>
        </div>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <span className="footer-copy">
            &copy; 2025 Nishit Rajput · Built with React &amp; TanStack Start
          </span>
